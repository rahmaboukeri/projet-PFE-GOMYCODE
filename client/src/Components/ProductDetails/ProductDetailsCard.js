            ...
            <div className="col-span-2 p-5">
              ...
              <div className="flex justify-between items-center mt-6 pt-6">
                <div className="flex items-center"> <img src="https://i.imgur.com/EEguU02.jpg" width={60} className="rounded-full " />
                  <div className="flex flex-col ml-3"> <span className="md:text-md font-medium"> {Productt.name} </span> <span className="text-xs font-light text-gray-400">#41551</span> </div>
                </div>
                <div className="flex justify-center items-center">
                  ...
                  <div className="pr-8 "> <span className="text-xs font-medium"> {Productt.Price} </span> </div>
