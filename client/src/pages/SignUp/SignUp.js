...
const SignUp = ({ history }) => {
  ...
  return (
    <div style={{justifyContent:"center",width:"80%"}} className="container-fluid px-lg-1 px-xl-5 py-5 mx-auto">
      ...
      <div  className="card card0 border-0">
        <div  className="row d-flex">
          ...
          <div className="col-lg-6">
            <div style={{backgroundColor:"#D8AC9C"}} className="card2 card border-0 px-4 py-5">
