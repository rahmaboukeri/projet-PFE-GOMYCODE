    ...
    return (
        <div>
            <>
                    ...
                    <div className="map"> <iframe src="https://snazzymaps.com/embed/2369" width="100%" height="100%" style={{border: 'none'}} />
                    </div>
                    <div className="content">
                        ...
                        <div className="other">
                            ...
                            <h2>More Methods </h2>
                            <h3>Email</h3>
                            <div className="svg-wrap"> <a href="mailto:connor@connorgaunt.com"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 485.211 485.211">
                            ...
                            <h3>Connect</h3>
                            <div className="svg-wrap"> <a href="http://instagram.com/connorgaunt" target="_blank"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <div className="form">
                            <h1>Get In Touch</h1>
                            <form action>
                            <div className="flex-rev"> <input type="text" placeholder="Connor Gaunt" name="name" id="name" /> <label htmlFor="name">Full Name</label> </div>
                            <div className="flex-rev"> <input type="email" placeholder="connor@connorgaunt.com" name="email" id="email" /> <label htmlFor="email">Your Email</label> </div>
                            <div className="flex-rev"> <textarea placeholder="I have an idea for a project...." name="message" id="message" defaultValue={""} /> <label htmlFor="message">Email Message</label> </div> <button>Send Email</button>
                            </form>
                        </div>
                        </div>
                    </div>
